...
Route::get('/', function () {
    ...
    // Use these to determine when they'll hit a 60 minute episode
    $ep = (60 - $b) / $m;
    $hourLongEpisode = ceil($ep);

    return view('welcome', compact('labels', 'series', 'twenty', 'avgLength', 'numUnderTwenty', 'longestLength', 'hourLongEpisode'));
});
